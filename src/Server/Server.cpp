...
async::Task<> Server::onReceive(json::Value value) {
  ...
  if (const auto result = object->getString("method")) {
    ...
    if (id) {
      co_await response(std::move(*id), proto::ErrorCodes::InvalidRequest,
                        "Method not found");
    }
    co_return;
  }
  ...
  if (id) {
    ...
    log::info("Handled notification: {}, took {}ms", method,
              timer.getWallTime());
  }
...
async::Task<json::Value> Server::onRequest(llvm::StringRef method,
                                           json::Value value) {
...
async::Task<json::Value> Server::onTextDocument(llvm::StringRef method,
                                                json::Value value) {
...
async::Task<json::Value> Server::onContext(llvm::StringRef method,
                                           json::Value value) {
  if (method == "current") {
...
async::Task<json::Value> Server::onIndex(llvm::StringRef method,
                                         json::Value value) {
  co_return json::Value(nullptr);
}

async::Task<> Server::onNotification(llvm::StringRef method,
                                     json::Value value) {
...
async::Task<> Server::response(json::Value id, proto::ErrorCodes code,
...
async::Task<> Server::registerCapacity(llvm::StringRef id,
  ...
  co_await request(
      ...
      json::Object{
          {"registrations", json::Array{json::Object{
                                {"id", id},
                                {"method", method},
