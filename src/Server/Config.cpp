...
template <typename Object> static void parse(Object &object, auto &&value) {
...
std::expected<void, std::string> load(llvm::StringRef execute,
...
template <typename Object> static void replace(Object &object) {
