...
class TypePrinter : clang::TypeVisitor<TypePrinter> {
public:
};

class InlayHintsCollector : public FilteredASTVisitor<InlayHintsCollector> {
public:
...
private:
    ...
    void addInlayHint(InlayHintKind kind, clang::SourceLocation location, std::string label) {}
