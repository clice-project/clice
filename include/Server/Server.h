...
public:
  ...
  async::Task<json::Value> onTextDocument(llvm::StringRef method,
                                          json::Value value);
...
private:
  ...
  async::Task<> response(json::Value id, proto::ErrorCodes code,
                         llvm::StringRef message = "");

  /// Send an register capability to the client.
  async::Task<> registerCapacity(llvm::StringRef id, llvm::StringRef method,
